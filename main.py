        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with pyzipper.AESZipFile(
                ...
                for i, file_info in enumerate(user_files[user_id], 1):
                    try:
                        ...
                        def download_progress(current, total):
                            asyncio.create_task(send_progress(message, current, total, file_name, "دانلود"))

                        await client.download_media(file_msg, file_path, progress=download_progress)
                ...
                def upload_progress(current, total):
                    asyncio.create_task(send_progress(message, current, total, zip_file_name, "آپلود"))
